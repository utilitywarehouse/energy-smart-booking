...
//
//	mockgen -source=api.go -destination ./mocks/api_mocks.go
//
...
func (mr *MockBookingDomainMockRecorder) CreateBooking(ctx, params any) *gomock.Call {
...
func (mr *MockBookingDomainMockRecorder) CreateBookingPointOfSale(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) GetAccountAddressByAccountID(ctx, accountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) GetAvailableSlots(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) GetAvailableSlotsPointOfSale(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) GetClickLink(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockBookingDomain) GetCustomerBookings(ctx context.Context, accountID string) ([]*v1.Booking, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCustomerBookings", ctx, accountID)
	ret0, _ := ret[0].([]*v1.Booking)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetCustomerBookings indicates an expected call of GetCustomerBookings.
func (mr *MockBookingDomainMockRecorder) GetCustomerBookings(ctx, accountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) GetCustomerContactDetails(ctx, accountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) GetCustomerDetailsPointOfSale(ctx, accountNumber any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) ProcessEligibility(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBookingDomainMockRecorder) RescheduleBooking(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSmartMeterInterestDomainMockRecorder) RegisterInterest(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPublisherMockRecorder) Sink(ctx, proto, at any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
