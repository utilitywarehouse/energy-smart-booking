...
type AutoGenerated struct {
	...
	Mpan                       string `json:"Mpan,omitempty"`
	Mprn                       string `json:"Mprn,omitempty"`
	ElecJobTypeCode            any    `json:"ElecJobTypeCode,omitempty"`
	GasJobTypeCode             any    `json:"GasJobTypeCode,omitempty"`
	CalendarAvailabilityResult []struct {
		AppointmentDate string `json:"AppointmentDate,omitempty"`
		AppointmentTime string `json:"AppointmentTime,omitempty"`
	} `json:"CalendarAvailabilityResult,omitempty"`
